...
return (
  <div className=' pt-16'>
    ...
    <div className='flex flex-col lg:flex-row justify-center items-center space-x-8 space-y-6'>
      <div className="flex flex-col justify-center items-center">
        <img className='w-[122px] h-[122px] mb-[-30px] z-50' src={serviceImg1} alt="" />
        <h2 className='text-center border rounded-t-xl pt-16 px-6 pb-6 font-bold  text-[#222527]'><p>Sofa Cleaning</p> <p>Service</p></h2>
      </div>
      <div className="flex flex-col justify-center items-center">
        <img className='w-[122px] h-[122px] mb-[-30px] z-50' src={serviceImg2} alt="" />
      ...
      <div className="flex flex-col justify-center items-center">
        <img className='w-[122px] h-[122px] mb-[-30px] z-50' src={serviceImg3} alt="" />
        <h2 className='text-center border rounded-t-xl pt-16 px-5 pb-5 font-bold  text-[#222527]'><p>Bathroom Deep</p> <p>Cleaning</p></h2>
      </div>
      <div className="flex flex-col justify-center items-center">
        <img className='w-[122px] h-[122px] mb-[-30px] z-50' src={serviceImg4} alt="" />
